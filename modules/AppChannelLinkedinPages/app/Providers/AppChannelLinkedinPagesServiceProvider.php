...
class AppChannelLinkedinPagesServiceProvider extends ServiceProvider
{
    ...
    protected string $name = 'AppChannelLinkedinPages';

    protected string $nameLower = 'appchannellinkedinpages';
    ...
    {
        if(get_option("linkedin_page_status", 0) || request()->segment(1) == "admin"){
