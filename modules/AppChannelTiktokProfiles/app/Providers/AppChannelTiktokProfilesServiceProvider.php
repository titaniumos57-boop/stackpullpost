...
class AppChannelTiktokProfilesServiceProvider extends ServiceProvider
{
    ...
    protected string $name = 'AppChannelTiktokProfiles';

    protected string $nameLower = 'appchanneltiktokprofiles';
    ...
    {
        if(get_option("tiktok_status", 0) || request()->segment(1) == "admin"){
    ...
    public function registerSubMenu(): void
    {
        Core::addSubMenu("AdminAPIIntegration", [
            [
                "uri" => "admin/api-integration/tiktok",
                "name" => "Tiktok",
                "position" => 550000,
