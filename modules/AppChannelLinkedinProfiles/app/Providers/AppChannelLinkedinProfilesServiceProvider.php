...
class AppChannelLinkedinProfilesServiceProvider extends ServiceProvider
{
    ...
    protected string $name = 'AppChannelLinkedinProfiles';

    protected string $nameLower = 'appchannellinkedinprofiles';
    ...
    {
        if(get_option("linkedin_profile_status", 0) || request()->segment(1) == "admin"){
    ...
    public function registerSubMenu(): void
    {
        Core::addSubMenu("AdminAPIIntegration", [
            [
                "uri" => "admin/api-integration/linkedin",
                "name" => __("Linkedin"),
                "position" => 435000,
