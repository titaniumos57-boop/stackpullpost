...
class AppChannelXProfilesServiceProvider extends ServiceProvider
{
    ...
    protected string $name = 'AppChannelXProfiles';

    protected string $nameLower = 'appchannelxprofiles';
    ...
    {   
        if(get_option("x_status", 0) || request()->segment(1) == "admin"){
