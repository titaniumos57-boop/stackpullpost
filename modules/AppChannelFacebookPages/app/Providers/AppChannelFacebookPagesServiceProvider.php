...
class AppChannelFacebookPagesServiceProvider extends ServiceProvider
{
    ...
    protected string $name = 'AppChannelFacebookPages';

    protected string $nameLower = 'appchannelfacebookpages';
    ...
    {
        if(get_option("facebook_page_status", 0) || request()->segment(1) == "admin"){
    ...
    public function registerSubMenu(): void
    {
        Core::addSubMenu("AdminAPIIntegration", [
            [
                "uri" => "admin/api-integration/facebook",
                "name" => "Facebook",
                "position" => 700000,
